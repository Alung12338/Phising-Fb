...
def loginSC():
	...
	if username =="alung" and password =="fahrul":
		print"\033[1;96m[✓] \033[1;92m success"
		time.sleep(1)
		login()
	else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCWLfNQtGlcLhtTqhNuobAuQ')
				menu()
